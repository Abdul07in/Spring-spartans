...
interface ReportingManagerApplicationsProps {
    applications: ApplicationSummary[];
    onBack: () => void;
}

const ReportingManagerApplications: React.FC<ReportingManagerApplicationsProps> = ({ applications, onBack }) => {
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <h2 className="text-xl font-bold text-gray-900">Team Applications</h2>
            </div>
...
export default ReportingManagerApplications;
