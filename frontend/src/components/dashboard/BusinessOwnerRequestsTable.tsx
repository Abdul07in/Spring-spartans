...
interface BusinessOwnerRequestsTableProps {
...
const BusinessOwnerRequestsTable: React.FC<BusinessOwnerRequestsTableProps> = ({
    requests,
    loading,
    page,
    pageSize,
    ...
    return (
        <div className="bg-white shadow rounded-lg overflow-hidden border border-gray-200">
            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                <h3 className="text-lg font-medium text-gray-900">Final Business Approvals</h3>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">App Owner</th>
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      ${request.requestedAction === 'retain' ? 'bg-green-100 text-green-800' :
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        {request.applicationOwnerName || 'N/A'}
                                    </td>
                                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                ...
                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <select
                            ...
                            className="mt-1 block w-full pl-3 pr-8 py-2 text-base border-gray-300 focus:outline-none focus:ring-purple-500 focus:border-purple-500 sm:text-sm rounded-md border"
                        >
                            {[5, 10, 20, 50].map((size) => (
...
export default BusinessOwnerRequestsTable;
